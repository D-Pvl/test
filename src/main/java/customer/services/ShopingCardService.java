...
public class ShopingCardService {
	...
	public static void initService() {
		...
		try {
			...
			tx = session.beginTransaction(); // important
	...
	public static Response createCart(Integer customerId, ShoppingCard cart) {
		...
		try {
			...
			List<Product> products = getProduct(cart.getProducts());
